...
public class PickUpActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnfarrived =  findViewById(R.id.cnfarrived);
        ...
        cnfarrived.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (cnfarrived.getText().toString().equalsIgnoreCase("Start Trip"))
                {
                    startActivity(new Intent(PickUpActivity.this,TripLocationActivity.class));
                    overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);

                }
                else
                {
                    cnfarrived.setTextColor(Color.BLACK);
                    cnfarrived.setText("Start Trip");
                    final int sdk = android.os.Build.VERSION.SDK_INT;
                    if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                        cnfarrived.setBackgroundDrawable(ContextCompat.getDrawable(PickUpActivity.this, R.drawable.background_shape_yellow) );
                    } else {
                        cnfarrived.setBackgroundDrawable(ContextCompat.getDrawable(PickUpActivity.this, R.drawable.background_shape_yellow) );
    ...
    public void onMapReady(final GoogleMap googleMap) {
        MapsInitializer.initialize(PickUpActivity.this);
        boolean success = googleMap.setMapStyle(
                MapStyleOptions.loadRawResourceStyle(
                        PickUpActivity.this, R.raw.silvermode));
